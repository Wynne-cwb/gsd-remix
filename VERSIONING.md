...
|------|-----------|---------------|---------|--------|---------|
| **Patch** | Bug fixes only | `1.27.1` | `latest` | `hotfix/1.27.1` | `npx gsd-remix@latest` |
| **Minor** | Fixes + enhancements | `1.28.0` | `latest` (after RC) | `release/1.28.0` | `npx gsd-remix@next` (RC) |
| **Major** | Fixes + enhancements + features | `2.0.0` | `latest` (after beta) | `release/2.0.0` | `npx gsd-remix@next` (beta) |
...
|-----|---------|-------------|
| `latest` | Stable production release | `npm install gsd-remix` (default) |
| `next` | Pre-release (RC or beta) | `npm install gsd-remix@next` (opt-in) |
...
4. Test the RC: `npx gsd-remix@next`

...
HIGHEST=$(gsd-remix-sdk query phases.list --pick directories[-1])
```
...
```bash
gsd-remix-sdk query commit "docs(roadmap): add gap closure phases {N}-{M}" .planning/ROADMAP.md .planning/REQUIREMENTS.md
```

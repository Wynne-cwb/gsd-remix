...
```bash
INIT=$(gsd-remix-sdk query init.todos)
...
```bash
slug=$(gsd-remix-sdk query generate-slug "$title" --raw)
```
...
```bash
gsd-remix-sdk query commit "docs: capture todo - [title]" .planning/todos/pending/[filename] .planning/STATE.md
```

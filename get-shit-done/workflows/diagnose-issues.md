...
```bash
AGENT_SKILLS_DEBUGGER=$(gsd-remix-sdk query agent-skills gsd-debugger 2>/dev/null)
...
```bash
gsd-remix-sdk query commit "docs({phase_num}): add root causes from diagnosis" ".planning/phases/XX-name/{phase_num}-UAT.md"
```
</step>

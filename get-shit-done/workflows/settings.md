...
```bash
gsd-remix-sdk query config-ensure-section
...
AskUserQuestion([
  {
    ...
    multiSelect: false,
    options: [
      { label: "Balanced (Recommended)", description: "Opus for planning/research/debugging, Sonnet for execution/verification (unified slim allocation)" },

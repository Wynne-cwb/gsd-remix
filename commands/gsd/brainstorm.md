...
step — it is native to gsd-remix (self-contained, no external skill, no browser
visual-companion). Divergent ideation is out of scope; bring the idea, leave with a PRD.

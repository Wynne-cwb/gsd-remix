...
Project context, phase list, and state are resolved inside the workflow using init commands (`gsd-remix-sdk query init.milestone-op`, `gsd-remix-sdk query roadmap.analyze`). No upfront context loading needed.
</context>

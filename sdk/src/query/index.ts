...
import { routeRiskScan } from './route-risk-scan.js';
import { routeSizeClassify } from './route-size-classify.js';
...
export function createRegistry(
  ...
  registry.register('route next-action', routeNextAction);
  registry.register('route.risk-scan', routeRiskScan);
  registry.register('route risk-scan', routeRiskScan);
  registry.register('route.size-classify', routeSizeClassify);
  registry.register('route size-classify', routeSizeClassify);
  registry.register('route.escalate', routeEscalate);
  registry.register('route escalate', routeEscalate);
  ...
  registry.register('failure preflight', failurePreflight);
  registry.register('failure.promote-phase', failurePromotePhase);
  registry.register('failure promote-phase', failurePromotePhase);

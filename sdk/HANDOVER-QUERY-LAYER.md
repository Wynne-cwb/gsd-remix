...
- **Issue:** [Wynne-cwb/gsd-remix#2302](https://github.com/Wynne-cwb/gsd-remix/issues/2302) — Phase 3 SDK query parity, registry, docs (umbrella #2007).
- **Workspace:** `D:\Repos\get-shit-done` (PBR backport). **Upstream:** `Wynne-cwb/gsd-remix`. Confirm branch with `git branch` (typical: `feat/sdk-phase3-query-layer`).
...
| Role                                    | GitHub                                                                                 | Notes                                                                                                                                                                                                                                       |
| --------------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Product / requirements anchor**       | [#2007](https://github.com/Wynne-cwb/gsd-remix/issues/2007)                        | Problem statement, user stories, and target architecture for the SDK-first migration. **Do not** treat its original acceptance-checklist boxes as proof of what is merged upstream; work was split into phased PRs after maintainer review. |
| **Phase 3 execution scope**             | [#2302](https://github.com/Wynne-cwb/gsd-remix/issues/2302) **+ this handover**    | What this branch is actually doing now: registry/CLI parity, docs, harness gaps, runner alignment follow-ups as listed below.                                                                                                               |
| **Patch mine (if local tree is short)** | [PR #2008](https://github.com/Wynne-cwb/gsd-remix/pull/2008) and matching branches | Large pre-phasing PR; cherry-pick or compare when something looks missing vs that line of work.                                                                                                                                             |
